...
namespace Droid_Inventory_Management_Tool_Revised
{
    class UserInterface
    {
        ...
        public void DisplayMainMenu()
        {
            ...
            Console.WriteLine("3. Sort the list of droids");
        ...
        public void SortDroidList() 
        {
            ...
            if (choice == 1)
            {
                this.droidCollection.PriceSort();
            }
            else
                this.droidCollection.TypeSort();
        }
        ...
        {
            Console.WriteLine("How would you like to sort the droids?");
            Console.WriteLine("1. Price");
            Console.WriteLine("2. Droid type");
        }
    }
}
